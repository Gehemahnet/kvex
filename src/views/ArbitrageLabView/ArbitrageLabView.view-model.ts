...
import type { ArbitrageOpportunity, OpportunityStatus } from "../../hooks/useArbitrageLabSocket/types";
...
export const useArbitrageLabViewModel = () => {
	const {
		opportunities,
	...
	const tableData = computed(() => {
		return filteredOpportunities.value.map((o) => ({
			...
			totalFeesDisplay: o.totalFeesBps.toFixed(1),
